...
@Configuration // ua.univerpulse.webchat.config Database
@EnableTransactionManagement
@PropertySource("classpath:hibernate.properties") // file with properties connection to DB
@EnableJpaRepositories(value = "ua.univerpulse.webchat.mvc.repository") // where find classes with Repository
